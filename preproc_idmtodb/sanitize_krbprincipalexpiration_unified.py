import sys
from user_found_json_2 import users_dict
from user_ldap_found_2 import users_ldap_dict
from VPN_Zeus_28042023_mod import users_vpn_dict
...
print("username,name,surname,uid,gid,group_name,division,creation_date,expiration_date,vpn_expiration_date,email") #,no_cmcc,closing_date,status")I
...
for i in users_dict:
    ...
    print("{},{},{},{},{},{},{},{},{},{},{}".format(username, i["givenname"][0], i["sn"][0], uidnumber, int(i["gidnumber"][0]), group, division, creation_date, krbPrincipalExpiration, vpn_expiration_date, i["mail"][0])) 
    cnt += 1
