...
./idmtodb $PROMPT_ON_INSERT $PROMPT_ON_UPDATE $PROMPT_ON_DELETE $MAX_USERS "$INPUT_FILE" "$USERSIDM_SERVER" "$USERSIDM_USER" "$USERSIDM_PASSWORD" "$USERSIDM_DATABASE" "$MAIL_CMD" "$MAIL_FROM" "$MAIL_TO"
